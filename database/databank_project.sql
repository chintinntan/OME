...
--
-- Host: 127.0.0.1
-- Generation Time: Jan 30, 2015 at 10:23 AM
...
CREATE DEFINER=`root`@`localhost` PROCEDURE `get_teach_subject_details`(IN `acct_id` INT(10))
BEGIN
...
BEGIN
	SELECT DISTINCT student_exam_answer.student_id,
				account.last_name,
				account.first_name,
				account.middle_name
	FROM databank_project.student_exam_answer
...
(104, 3, '1001491', '1001491', '`Q´Z6ºb-\r\\7ÊµAË', 'QUITORIANO', 'JESSRYLL', 'PACHECO', 1, '2015-01-26 00:03:22', '2015-01-30 14:46:06'),
...
(117, 3, '1401218', '1401218', '`Q´Z6ºb-\r\\7ÊµAË', 'DACUDAO', 'KYLE GERARD', 'DANGO', 1, '2015-01-26 16:22:51', '2015-01-30 15:16:32'),
...
(15, 103, '2015-01-14', 'test', 1, 5, '12345', 0),
(16, 103, '2015-01-28', 'test3', 1, 5, '12345', 0),
(17, 103, '2015-01-27', 'test4', 1, 5, '12345', 0),
(18, 103, '2015-01-30', 'title', 1, 5, '12345', 1);
...
(45, 5, 1, 1, 'A computer has six logical units. Which of the following is not part of the six?', '2015-01-26 00:32:11', '2015-01-26 00:32:11', 0.1, 1),
(46, 5, 1, 1, '  The programming language Java was originally called _________.', '2015-01-26 00:32:48', '2015-01-26 00:32:48', 0, 1),
(47, 5, 1, 1, 'The following are the classes of programming languages except', '2015-01-26 00:37:06', '2015-01-26 00:37:06', 0.1, 1),
(48, 5, 1, 1, 'A compiler is a program that translates ______________.', '2015-01-26 00:37:52', '2015-01-26 00:37:52', 0.7, 1),
(49, 5, 1, 1, 'Wirth developed this language for teaching structured programming.', '2015-01-26 00:38:15', '2015-01-26 00:38:15', 0, 1),
(50, 5, 1, 1, 'He was the creator of C language.', '2015-01-26 00:38:37', '2015-01-26 00:38:37', 0, 1),
(51, 5, 1, 1, 'It is the fourth phase of the execution of C programs. ', '2015-01-26 00:38:57', '2015-01-26 00:38:57', 0, 1),
(52, 5, 1, 1, 'COBOL stands for', '2015-01-26 00:39:21', '2015-01-26 00:39:21', 0, 1),
(53, 5, 1, 1, 'It allows programmers to type-in their codes into the computer ', '2015-01-26 00:39:40', '2015-01-26 00:39:40', 0, 1),
(54, 5, 1, 1, 'Today, does personal computing still exist', '2015-01-26 00:40:09', '2015-01-26 00:40:09', 0, 1),
(55, 5, 1, 1, 'How did IBM personal computer contributed to the business and industry? ', '2015-01-26 00:40:31', '2015-01-26 00:40:31', 0, 1);
