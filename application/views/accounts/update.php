...
<div class="panel panel-default">
	...
	<label class="col-sm-2 control-label">ID NUMBER:</label>
		<div class="col-sm-2">
			<?php echo form_input('id_number','set value of data','class="form-control" placeholder="ID NUMBER"');?>
		</div>
	<label class="col-sm-3 control-label">Acct. Type:</label>
		<div class="col-sm-3">
			<?php $option_acct=array('0'=>'--Select Acct. Type--');
				echo form_dropdown('section',$option_acct,'select option of data','class="form-control"'); ?>
		</div>
	</div>
	<div class="form-group">
		<label class="col-sm-2 control-label">USERNAME:</label>
		<div class="col-sm-4">
			<?php echo form_input('username','set value of data','class="form-control" placeholder="USERNAME"');?>
		</div>
	</div>
	...
	<div class="form-group">
		...
		<?php echo form_input('lastname','set value of data','class="form-control" placeholder="FIRSTNAME"');?>
		</div>
		<div class="col-sm-3">
			<label class="col-sm-2 control-label">MIDDLENAME</label>
		<?php echo form_input('lastname','set value of data','class="form-control" placeholder="MIDDLENAME"');?>
		</div>
		<div class="col-sm-3">
			<label class="col-sm-2 control-label">LASTNAME</label>
		<?php echo form_input('lastname','set value of data','class="form-control" placeholder="LASTNAME"');?>
		</div>
	</div>
	</div>
